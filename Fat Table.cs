...
namespace OS_project2
{
    class Fat_Table
    {
        ...
        {
            // for loop to fill the array of (-1) if the block is full or (0) if the block is empty
        ...
        // to write the values of array in the fat table
        ...
        public static int[] get_fat_table()
        {
            ...
            // convert from byte to int and store them in fat_table
